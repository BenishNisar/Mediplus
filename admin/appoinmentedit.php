        ...
        <form action="#" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="email" class="form-control" name="email" value="<?php echo $data[1]; ?>" id="email" placeholder=""  required>
            ...
            <div class="col-sm-6">
              ...
              <input type="phone" class="form-control" name="phone" value="<?php echo $data[2]; ?>" id="phone" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="department" value="<?php echo $data[3]; ?>" id="text" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="doctor" value="<?php echo $data[4]; ?>" id="text" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-12">
              ...
              <input type="date" class="form-control" name="date" value="<?php echo $data[5]; ?>" id="text" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
...
<textarea name="message" value="<?php echo $data[6]; ?>"  class="form-control" rows="5"></textarea>
    ...
    <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="user" value="<?php echo $data[7]; ?>" id="text" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
...
if(isset($_POST["submit"])){
    ...
    $update="UPDATE `appointement` SET `email`='$email',`phone`='$phone',`department`='$department',`doctor`='$doctor',`date`='$date',`message`='$message',`user`='$user' WHERE `id`=$id";
