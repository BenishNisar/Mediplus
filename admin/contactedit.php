      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form action="#" method="POST"  class="needs-validation" novalidate>
          ...
          <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="uname" value="<?php echo $data[1];?>" id="text" placeholder=""  required>
            ...
            <div class="col-sm-6">
              ...
              <input type="email" class="form-control" name="email" value="<?php echo $data[2];?>" id="email" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="phone" value="<?php echo $data[3];?>" id="phone" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="subject" value="<?php echo $data[4];?>" id="text" placeholder=""  required>
              <div class="invalid-feedback">
                Valid first name is required.
              </div>
            </div>
...
<textarea name="message" value="<?php echo $data[5];?>"  class="form-control" rows="5"></textarea>
...
if(isset($_POST["submit"])){
    ...
    $update="UPDATE `contact` SET `name`='$uname',`email`='$email',`phone`='$phone',`subject`='$subject',`message`='$message' WHERE `id`=$id";
