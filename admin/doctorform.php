        ...
        <form action="#" method="POST" class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" name="image" id="lastName" placeholder="" value="" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              <label for="lastName" class="form-label">Timing</label>
              <input type="time" class="form-control" name="timing" id="lastName" placeholder="" value="" required>
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
...
<!-- button -->
<div class="col-sm-6">
              <label for="address" class="form-label">Department Name</label>
...
<div class="col-12 mt-5">
              <label for="address" class="form-label">Education</label>
              <input type="text" class="form-control" name="education" placeholder="Qualification" required>
              <div class="invalid-feedback">
                Please enter your shipping address.
              </div>
     </div>
...
if(isset($_POST["submit"])){
    $connection=mysql_connect("localhost","root","","mediplus");
    $title=$_POST["title"];
