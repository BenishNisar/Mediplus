...
<div class="box" style="text-align:center;">
    <a href="topbarform.php"><button>Create new</button></a>
...
<tr>
    ...
    <td> <a href="topbaredit.php?id=<?php echo $data[0]; ?>"><button>Edit</button></a>    </td>
    <td> <a href="topbardelete.php?id=<?php echo $data[0]; ?>"><button>Delete</button></a>    </td>
