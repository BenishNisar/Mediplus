...
<div class="box" style="text-align:center;">
    <a href="newsform.php"><button>Create new</button></a>
...
$new="SELECT * FROM `newsletter`";
$response=mysqli_query($connection,$new);
...
<tr>
    ...
    <td> <a href="newsedit.php?id=<?php echo $data[0]; ?>"><button>Edit</button></a>    </td>
    <td> <a href="newsletterdelete.php?id=<?php echo $data[0]; ?>"><button>Delete</button></a>    </td>
