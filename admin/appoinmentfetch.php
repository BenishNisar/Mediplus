...
<div class="box" style="text-align:center;">
    <a href="appoinmentform.php"><button>Create new</button></a>
...
<tr>
    ...
    <td><a href="appoinmentedit.php?id=<?php echo $data[0]; ?>"><button class="good">Edit</button></a></td>
    <td><a href="appoinmentdelete.php?id=<?php echo $data[0]; ?>"><button class="good">Delete</button></a></td>
</tr>
<?php
}
}
